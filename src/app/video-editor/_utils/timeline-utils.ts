/**
 * @deprecated 이 파일의 모든 함수들이 common-clip-utils.ts로 통합되었습니다.
 * 새로운 코드에서는 common-clip-utils.ts를 사용하세요.
 */

import { BaseClip } from './common-clip-utils';
...
// magneticPositioning은 common-clip-utils.ts로 이동됨
